...
<div class="order-detail-grid">
    <div class="order-info-card">
        ...
        <p><strong>Müşteri:</strong> <c:out value="${order.userName}" /></p>
        ...
        <p><strong>Toplam Tutar:</strong> <fmt:formatNumber value="${order.totalAmount}" type="currency" currencySymbol="₺" maxFractionDigits="2" /></p>
    </div>
    ...
    <table>
        ...
        <tbody>
            <c:choose>
                ...
                <c:otherwise>
                    <tr>
                        <td colspan="4" style="text-align: center; padding: 30px; color: #7f8c8d;">Ürün bulunamadı.</td>
                    </tr>
                </c:otherwise>
            </c:choose>
        </tbody>
