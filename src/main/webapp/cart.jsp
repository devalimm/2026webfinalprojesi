                ...
                <c:choose>
                    ...
                    <c:otherwise>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="entry" items="${sessionScope.cart}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <fmt:formatNumber value="${subtotal}" type="currency" currencyCode="TRY"
                                                    maxFractionDigits="2" />
                                            </td>
                                            <td>
                                                <form action="${pageContext.request.contextPath}/cart" method="post">
                        ...
                        <div class="cart-summary">
                            <h3>
                                Genel Toplam:
                                <fmt:formatNumber value="${grandTotal}" type="currency" currencyCode="TRY"
                                    maxFractionDigits="2" />
                            </h3>
                            <a href="${pageContext.request.contextPath}/order" class="btn btn-success">Siparişi
                                Tamamla</a>
                            <a href="${pageContext.request.contextPath}/home" class="btn btn-secondary">Alışverişe Devam
                                Et</a>
                        </div>
                    </c:otherwise>
                </c:choose>
